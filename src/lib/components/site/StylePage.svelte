...
<section class="page-hero">
  <div class="container">
    <p class="eyebrow-page"><a href="/lifestyle" style="color:inherit">Lifestyle styles</a></p>
  ...
  <div class="container">
    <div class="grid grid-3">
      {#each style.grid as g}
        <div class="reveal pending" use:reveal>
          <ProductScene photo={g.photo} icon={g.icon} width={g.width} badge="Lifestyle &middot; {style.name}" />
        </div>
      {/each}
    </div>
  </div>
